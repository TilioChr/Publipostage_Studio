...
function ProjectItem(props) {
  ...
  const withAsset = props.attachedPDF || props.attachedData;
      ...
      <div className="preview">
        ...
        {withAsset && (
          ...
          >
            ...
            {/* vvv Div transparante qui permet le transfert du statut Hovered sans interuption vvv */}
            <div className="hoverWay"></div>
            {showPopup && (
              <div className="popup">
                {props.attachedPDF && <span>{props.attachedPDF}</span>}
                {props.attachedData && <span>{props.attachedData}</span>}
              </div>
            )}
          </div>
        )}
